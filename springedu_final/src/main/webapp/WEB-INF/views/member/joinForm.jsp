					...
					<div class="formSet">
						<div class="formBox">
							...
							<span class="input_form">
								<form:input type="text" id="id" name="id" path="id" placeholder="example@example.com" maxlength="40" />
							</span>
						</div>
						<div class="err_form">
...
<%-- 							<form:errors path="id" cssClass="errmsg" id="id_errmsg"></form:errors> --%>
						...
						<div class="formBox">
							...
							<span class="input_form">
								<form:input type="password" id="pw" name="pw" path="pw" placeholder="8~10자리의 영어/숫자" maxlength="10" />
							</span>
						</div>
						<div class="err_form">
...
<%-- 							<form:errors path="pw" cssClass="errmsg" id="pw_errmsg"></form:errors> --%>
						...
						<div class="formBox">
							...
							<span class="input_form">
								<input type="password" name="pwChk" id="pwChk" maxlength="10">
							</span>
						</div>
						<div class="err_form">
						...
						<div class="formBox">
							<span class="ast">*</span> <span class="label"><form:label
									...
									placeholder="010-1234-5678" maxlength="13" /></span>
						</div>
						<div class="err_form">
...
<%-- 							<form:errors path="tel" cssClass="errmsg" id="tel_errmsg"></form:errors> --%>
						...
						<div class="formBox">
							...
							<span class="input_form"><form:input type="text" id="nickname" name="nickname" path="nickname" placeholder="3~10자리의 한글/영어" maxlength="10" /></span>
						</div>
						<div class="err_form">
